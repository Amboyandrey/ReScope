"""Alembic runtime config — reads the owner DB URL from app settings and diffs against our ORM metadata."""
...
# Migrations always run as the owner role, never the RLS-restricted app role.
